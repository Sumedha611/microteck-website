...
let currentView = "categories"; // categories | category | product
          ...
          <div class="content-inner">
            ...
            <div class="card">
              ...
              <ul>
                ...
                <li onclick="openProduct('Golden Zink 21')">Golden Zink 21</li>
          ...
          <div class="content-inner">
            <div class="card">
              ...
              <ul>
                ...
                <li onclick="openProduct('UDAN-32')">UDAN-32</li>
              </ul>
            </div>
        ...
        <div class="content-inner">
          ...
          <div class="card">
            ...
            <ul>
              ...
              <li onclick="openProduct('Ultymax Gold')">Ultymax Gold</li>
            </ul>
          </div>
        ...
        <div class="content-inner">
          ...
          <div class="card">
            ...
            <ul>
              ...
              <li onclick="openProduct('C-VID 20')">C-VID 20</li>
...
productData["Ultimax Gold"] = { img: "19.png", info: [
  "➜ Microteck ULTYMAX GOLD contains natural organic nutrients that help increase the yield of various crops.<br>" +
  "➜ Minimizes flower and fruit drop.<br>" +
  "➜ Helps plants withstand stress conditions such as drought.<br>" +
  "➜ Recommended for all field crops, fruit crops, vegetables, and commercial crops."
] };
...
productData["C-vid 20"] = { img: "05.png", info: "Growth promoting rhizobacteria." };
...
productData["Shikari - L"] = {img: "52.png",info: [
  "➜ A bio-product.<br>" +
...
productData["Shikari Gr"] = {img: "Shikaril.png",info: "Granular speciality product for soil application."};
productData["Nutricap"] = {img: "13.png",info: [
...
productData["Nutricap - Banana Spl"] = {img: "12.png",info: [
  "➜ Microteck NUTRICAP is enriched with natural plant growth substances and organic nutrients.<br>" +
  "➜ Helps significantly in the growth and development of banana bunches, resulting in higher yield.<br>" +
  "➜ Composition per capsule (750 mg): Fulvic acid (derived from organic manure) – 10% w/w.<br>" +
  "➜ Composition per capsule (750 mg): Moisture – 5% w/w.<br>" +
...
function openProduct(productName) {
  ...
  const currentIndex = micronutrientProducts.indexOf(key);

  const prevProduct =
    currentIndex > 0
      ? micronutrientProducts[currentIndex - 1]
      : null;

  const nextProduct =
    currentIndex >= 0 &&
    currentIndex < micronutrientProducts.length - 1
      ? micronutrientProducts[currentIndex + 1]
      : null;
